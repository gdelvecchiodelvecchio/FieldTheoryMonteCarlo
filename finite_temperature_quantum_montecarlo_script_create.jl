...
function sg_montecarlo_equilibrate_forever(dτ=0.05, dx=0.05, σ0=random_field(100, 100; dτ=0.05, dx=dτ); α=1., γ=1., β=1.)
    n, m = size(σ0)
...
sample = sg_montecarlo_equilibrate_forever(0.05, 0.05)
